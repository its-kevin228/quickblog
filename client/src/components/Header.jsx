...
const Header = () => {
    return (
        <div className='mw-8 sm:mx-16 xl:mx-24 relative'>
            <div className='text-center mt-20 mb-8'>
                ...
                <h1 className='text-3xl sm:text-6xl font-semibold text-gray-700 sm: leadig-16' >
                    Your own <span className='text-primary'>blogging </span> <br /> platform.
                </h1>
                <p className=' my-6 sm:my-8 max-w-2xl mx-auto max-sm:text-xs text-gray-300 rounded overflow-hidden'>This is your space to think out loud, to share what matters,
