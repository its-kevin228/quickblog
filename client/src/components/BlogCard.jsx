...
const navigate = useNavigate();
  ...
  return (
    <div onClick={() => navigate(`/blog/${_id}`)} className='w-full rounded-full overflow-hidden shadow hover:scale-102 hover:shadow-primary/25 duration-300 cursor-pointer'>
